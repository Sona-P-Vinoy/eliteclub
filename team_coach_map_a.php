       ...
       <div class="recent-sales box">
        ...
        <div class="container">
          ...
          <table id ="customers">
            ...
            <?php
            include('config.php');      
            $query="SELECT * from team_coach_map left join team_reg ON team_reg.teamr_id = team_coach_map.team_id left join register on register.reg_id = team_coach_map.coach_id;";
            $data = mysqli_query($con,$query);
