          ...
          <table id ="customers">
            ...
            <?php
              ...
              while($res=mysqli_fetch_assoc($data)){
                $type = $res['reg_id'];
                $query2 = "select * from `register` where `reg_id`='$type' and `reg_status` = 0"; 
                ...
                <tr>
                  ...
                  <td>
                    <a href="edit_organizer.php?am=<?php echo $row['reg_id'];?>">
                        <input type="button" style="background-color:grey;" value="Edit"></a>
                      <a href="del_organizer.php?am=<?php echo $row['reg_id'];?>">
