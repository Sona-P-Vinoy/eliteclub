   ...
   <div class="sidebar">
    ...
    <ul class="nav-links">
      ...
      <li>
        <a href="#">
          <i class='bx bx-user'></i>
          <span class="links_name"onclick="location.href='../addplayer.php';" style="cursor: pointer;">Add Organizer</span>
        </a>
      </li>
      <li>
        <a href="#">
  ...
  <section class="home-section">
    ...
    <div class="home-content">
      <div class="overview-boxes">
        <div class="box" onclick="location.href='view_trmt_a.php';" style="cursor: pointer;">
...
foreach($schedule AS $round => $games){
    echo "<a href='trmt_time.php'><div class='box'>Round: ".($round+1)."<BR>";
