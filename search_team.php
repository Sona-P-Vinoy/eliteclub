                            ...
                            <div class="col-md-7">
                                ...
                                <form action="search_team.php" method="POST">
                                    <div class="input-group mb-3">
                                        <input type="text" name="search" required value="<?php if(isset($_POST['search'])){echo $_POST['search']; } ?>" class="form-control" placeholder="Search player">
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    if(isset($_POST['search']))
                                    {
                                        ...
                                        //echo $filtervalues;
                                            $query1 = "SELECT * FROM `team_reg` WHERE CONCAT(teamr_name) LIKE '%$filtervalues%' and `team_status`=1";
                                        ...
                                        if(mysqli_num_rows($query_run) > 0)
                                        {
                                            foreach($query_run as $items)
                                            {
                                                ?>
                                                <tr>
                                                    <td><?= $items['teamr_id']; ?></td>
                                                    <td><img src="<?php echo $items['team_img'];?>"width="50px" height="50px"></td>
                                                    <td><?= $items['teamr_name']; ?></td>
                                                    <td><?= $items['team_sec_name']; ?></td>
                                                    <td><?= $items['team_sec_email']; ?></td>
                                                    <td><?= $items['team_ground_addr']; ?></td>
                                                </tr>
                                                <?php
                                            }
                                        }
