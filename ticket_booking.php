...
if(isset($_POST['submit'])){
  ...
  $amt = $_POST['amount'];
    ...
    $sql = "INSERT INTO `tbl_booking`(`ticket_id`, `tv_id`, `user_id`, `no_seats`, `amount`, `status`) VALUES ('$ticketid','$tvid',0,'$seat','$amt',1)";
      ...
      <div class="about-content">
        ...
        <table id ="customers">
          ...
          <tr>   
            ...
            <input type="textbox" name="amt" id="amt" placeholder="Enter place"/><br/><br/>
