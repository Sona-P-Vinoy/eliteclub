    ...
    <div class="home-content">
      <div class="sales-boxes">
       <div class="recent-sales box">
        ...
        <div class="container">
          <center><h3>Add Tournament</h3></center>
          <form action="#" method="POST" autocomplete="off" onsubmit="return validate();">

            <div class="row">
              <div class="col-25">
                <label for="teamname">Game Name</label>
              </div>
              <div class="col-75">
                <span></span> 
                <input type="text" id="t_name" name="t_name" placeholder="Game name..">
              </div>
            </div>
            <div class="row">
              <div class="col-25">
                <label for="teamname">Game Type</label>
              </div>
              <div class="col-75">
                <span></span> 
                <input type="text" id="t_name" name="t_name" placeholder="Game type..">
              </div>
            </div>
            <div class="row">
              <div class="col-25">
                <label for="teamname">Total Teams</label>
              </div>
              <div class="col-75">
                <span></span> 
                <input type="text" id="t_name" name="t_name" placeholder="Total Teams..">
              </div>
            </div>
            <div class="row">
              <div class="col-25">
                <label for="teamname">Start Date</label>
              </div>
              <div class="col-75">
                <span></span> 
                <input type="text" id="t_name" name="t_name" placeholder="Start Date..">
              </div>
            </div>
                 <div class="row">
              <div class="col-25">
                <label for="teamname">End Date</label>
              </div>
              <div class="col-75">
                <span></span> 
                <input type="text" id="t_name" name="t_name" placeholder="End Date..">
              </div>
            </div>
                 <div class="row">
              <div class="col-25">
                <label for="teamname">Entry fee</label>
              </div>
              <div class="col-75">
                <span></span> 
                <input type="text" id="t_name" name="t_name" placeholder="Entry fee..">
              </div>
            </div>
              <br>
             <div class="row">
              <input type="submit" id="submit" name="reg" value="Submit" >
            </div>
          </form>
        </div>
      </div>
